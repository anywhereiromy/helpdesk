...
function collectQuestionData (inquirer, data, callback) {
  ...
  const questions = [
    ...
    {
      type: 'list',
      message: 'Have you spent 10 trying to solve your problem?',
      name: 'spent_ten',
      choices: selections
    },
    {
      type: 'list',
      message: 'Have you researched your issue on Google, MDN and Stack Overflow?\nAn error message in your console is a good place to start!',
      name: 'googled',
      choices: selections
    },
    {
